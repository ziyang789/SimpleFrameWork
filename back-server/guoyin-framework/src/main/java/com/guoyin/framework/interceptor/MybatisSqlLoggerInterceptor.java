package com.guoyin.framework.interceptor;
...
public class MybatisSqlLoggerInterceptor implements Interceptor {
    private static final Logger log = LoggerFactory.getLogger(MybatisSqlLoggerInterceptor.class);
