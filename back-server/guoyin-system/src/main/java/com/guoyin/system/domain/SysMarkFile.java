 ...
 * @date 2021-09-17
 */
public class SysMarkFile extends BaseEntity
{
    ...
    private SysFileDir sysFileDir;

    public SysFileDir getSysFileDir()
    {
        if (sysFileDir == null)
        {
            sysFileDir = new SysFileDir();
        }
        return sysFileDir;
    }

    public void setSysFileDir(SysFileDir sysFileDir) {
        this.sysFileDir = sysFileDir;
    }
